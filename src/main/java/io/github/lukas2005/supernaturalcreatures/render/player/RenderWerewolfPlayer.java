...
public class RenderWerewolfPlayer extends LivingRenderer<AbstractClientPlayerEntity, ModelWerewolf<AbstractClientPlayerEntity>> {
    ...
    public ResourceLocation getEntityTexture(AbstractClientPlayerEntity entity) {
        SCMPlayer player = SCMPlayer.of(entity);
...
//    }
    ...
    public void renderArm(AbstractClientPlayerEntity clientPlayer, HandSide hand) {
        ...
        RendererModel arm = hand == HandSide.RIGHT ? model.bipedRightArm : model.bipedLeftArm;
        RendererModel armWear = hand == HandSide.RIGHT ? model.bipedRightArmwear : model.bipedLeftArmwear;
