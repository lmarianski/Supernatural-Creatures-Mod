...
public class EntityAlphaWerewolf extends MonsterEntity implements IAlphaWerewolf, IEntityActionUser {

    public static final DataParameter<Boolean> IS_TRANSFORMED = EntityDataManager.createKey(EntityAlphaWerewolf.class, DataSerializers.BOOLEAN);
    public static final DataParameter<Integer> PACK_RANK = EntityDataManager.createKey(EntityAlphaWerewolf.class, DataSerializers.VARINT);

    protected EntityAlphaWerewolf(EntityType<? extends MonsterEntity> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    protected void applyEntityAI() {
        ...
        this.targetSelector.addGoal(1, (new HurtByTargetGoal(this)).setCallsForHelp(EntityAlphaWerewolf.class));
        this.targetSelector.addGoal(2, new NearestAttackableTargetGoal<>(this, PlayerEntity.class, true));
        this.targetSelector.addGoal(3, new NearestAttackableTargetGoal<>(this, EntityAlphaWerewolf.class, 10, false, false, (e) -> ((EntityAlphaWerewolf)e).getPack() != getPack()));
    ...
    @Override
    public List<IBetaWerewolf> getFollowers() {
        return null;
    }
}
